...
const SECTIONS = [
  {
    ...
    items: [
      { label: "Arquitectura", value: "MONAI U-Net (3D Full-Resolution)" },
      { label: "Variante", value: "3D Sliding Window Inference" },
      { label: "Framework", value: "MONAI 1.x + PyTorch 2.2.0" },
  ...
  },
  {
    ...
    items: [
      { label: "Pipeline", value: "MONAI Compose Transforms" },
      { label: "Remuestreo", value: "Isotrópico adaptativo (Spacingd)" },
      { label: "Normalización", value: "Z-score / Escala HU por instancia" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Patch Size", value: "[64, 64, 64] voxels (model_config.py)" },
      { label: "Sliding Window Overlap", value: "50% (SlidingWindowInferer MONAI)" },

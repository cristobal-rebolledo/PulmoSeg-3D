    ...
    <div className="glass-card p-8 animate-[fade-in_0.4s_ease-out]">
      ...
      {!selectedFolder ? (
        ...
        <div className="rounded-2xl border p-6" style={{ borderColor: "var(--border-subtle)", backgroundColor: "var(--bg-input)" }}>
          ...
          {/* Nota informativa sobre cómo funciona el procesamiento */}
          <div
            className="mb-4 px-4 py-3 rounded-xl text-xs"
            style={{
              backgroundColor: "oklch(0.72 0.19 155 / 0.07)",
              borderLeft: "3px solid var(--color-success)",
              color: "var(--text-secondary)",
            }}
          >
            <span style={{ color: "var(--color-success)", fontWeight: 600 }}>✅ Upload Directo:</span>{" "}
            Los <strong>{dcmFiles.length} archivos DICOM</strong> seleccionados serán enviados al servidor
            para su procesamiento. El backend los guardará temporalmente y ejecutará el pipeline de inferencia
